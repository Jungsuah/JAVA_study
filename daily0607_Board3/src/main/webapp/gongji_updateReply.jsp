...
<table width="650" border="1" cellspacing="0" cellpadding="5">
  <tr>
    <td><b>번호</b></td>
    <td colspan="3"><input type="hidden" name="pageNumber" value="<%=pageNumber%>"><input type="text" name="id" size="70" value="<%=id%>" readonly></td>
  </tr>
  <tr>
    <td><b>제목</b></td>
    <td colspan="3"><input type="text" name="title" size="70" maxlength="70" value="<%=title%>"></td>
  </tr>
  <tr>
    <td><b>일자</b></td>
  ...
  <tr>
    <td><b>내용</b></td>
    <td colspan="3"><textarea style="width:500px; height:250px;" name="content" cols="70" rows="600"><%=content%></textarea></td>
  </tr>
  <tr>
    <td><b>원글</b></td>
    <td colspan="3"><%=gongji.getRootid()%></td>
  </tr>
  <tr>
    <td><b>댓글수준</b></td>
