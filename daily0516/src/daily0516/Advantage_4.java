...
public class Advantage_4 {// 특정일자 쿼리를 가져오기
	public static void main(String[] args) throws Exception {
		...
		// stock 테이블에 주식 영업 일자가 20051017인 행을 가져오는 쿼리를 작성한다.
		String k27_QueryTxt = String.format("select * from stock where bsop_date = '20051017';");
