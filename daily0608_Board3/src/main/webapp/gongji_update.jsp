...
<form method="post" name="fm" >
  <table width="650" border="1" cellspacing="0" cellpadding="5">
    <tr>
      <td><b>번호</b></td>
      <td><input type="hidden" name="rootId" value="<%=rootId%>"><input type="text" name="id" size="70" value="<%=id%>" readonly></td>
    </tr>
    <tr>
      <td><b>제목</b></td>
    ...
    <tr>
      <td><b>내용</b></td>
      <td><textarea class="textarea" name="content" cols="70" rows="10"><%=content%></textarea></td>
    </tr>
    <tr>
