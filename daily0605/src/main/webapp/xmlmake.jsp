...
//"com.mysql.cj.jdbc.Driver" 클래스를 동적으로 로드하기 위해 Java의 Class.forName 메서드를 호출하여
			...
			while (rset.next()) {
				...
				out.println("<studentid>" + rset.getString(3) + "</studentid>");
				out.println("<kor>" + rset.getString(4) + "</kor>");
				out.println("<eng>" + rset.getString(5) + "</eng>");
				out.println("<mat>" + rset.getString(6) + "</mat>");
