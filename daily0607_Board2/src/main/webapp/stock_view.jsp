...
<form method="post" name="fm" enctype="multipart/form-data">
  <table class="tablestyle" border="1" cellspacing="0" cellpadding="5">
    ...
    <tr>
      <td><b>상품명</b></td>
      <td><%=stockName.replaceAll("<", "&lt;").replaceAll(">", "&gt;")%></td>
    </tr>
    <tr>
      <td><b>재고현황</b></td>
    ...
    <tr >
      <td><b>상품설명</b></td>
      <td><textarea name="stockContent" class="textarea" readonly><%=stockContent.replaceAll("<", "&lt;").replaceAll(">", "&gt;")%></textarea></td>
    </tr>
    <tr>
	  <td><b>상품사진</b></td>
	  <td>
...
<table width=600px>
    <tr>
      ...
      <td><input type="button" value="재고수정" onclick="location.href='stock_updateNumber.jsp?id=<%=id%>'"></td>
    </tr>
  </table>
    </div>
  </form>
