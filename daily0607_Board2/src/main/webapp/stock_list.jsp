    ...
    <form method="post" name="fm"  action="getStock.jsp" onsubmit="return validateForm()">
        ...
        <tr>
            ...
            <% for (Stock stock : stockList) { %>
                <tr>
                    <td><a href='stock_view.jsp?id=<%=stock.getId()%>&pageNumber=<%=c%>'><%=stock.getId().replaceAll("<", "&lt;").replaceAll(">", "&gt;")%></a></td>
                    <td><a href='stock_view.jsp?id=<%=stock.getId()%>&pageNumber=<%=c%>'><%=stock.getName().replaceAll("<", "&lt;").replaceAll(">", "&gt;")%></a></td>
