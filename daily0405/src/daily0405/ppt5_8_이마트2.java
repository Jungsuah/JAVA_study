...
public class ppt5_8_이마트2 {// 굴림체 10
	public static void main(String[] args) {

		DecimalFormat k27_df = new DecimalFormat("###,###,###,###,###");// 세자리 마다 콤마 찍기

		LocalDateTime k27_now = LocalDateTime.now();// 현재시간 불러오기
		String k27_formatTime = k27_now.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));//날짜 출력 형식 포맷팅
		String k27_formatTime1 = k27_now.format(DateTimeFormatter.ofPattern("yyyyMMdd"));//날짜 출력 형식 포맷팅
		String k27_formatTime2 = k27_now.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));//날짜 출력 형식 포맷팅
		LocalDateTime k27_k = k27_now.minusHours(2);//현재시간에 2시간 빼기
		String k27_tk = k27_k.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));//날짜 출력 형식 포맷팅


		// 문자열 아이템 항목 배열 30개 선언 및 초기화
		String[] k27_itemname = { "a", "aaa", "aaaaa", "꿈꾸는콩 촌두부 마을", "철원 오대쌀10kg", "크리넥스 울트라 클린 아쿠아더블롱 30m30롤",
		...
		int[] k27_price = { 3000, 2990000, 12890000, 1950000, 29120, 33700, 4900, 900, 159030, 34110, 15040, 1500, 4500,
				980, 4100, 19900, 1080, 11880, 6784, 70400, 434280, 444808, 125020, 201348, 37344, 25262, 23564,
				93436, 90400, 42112000 };

		// 아이템별 수량 30개 선언 및 초기화
		int[] k27_num = { 6, 3, 5, 6, 2, 1, 2, 8, 4, 3, 8, 7, 5, 1, 6, 8, 2, 1, 4, 5, 2, 1, 5, 3, 1, 1, 3, 4, 1, 2 };

		// 면세항목 타입 30개 선언 및 초기화
		boolean[] k27_taxFree = { true, true, true, false, false, false, false, false, true, false, false, false, true,
				false, false, false, false, false, true, false, false, false, false, false, false, true, true, true,
				false, false, false, false };

		int k27_val_taxFreeTotal = 0;// 면세물품
		int k27_val_taxAmountTotal = 0;// 과세물품
