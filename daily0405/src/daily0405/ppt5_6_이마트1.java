...
public class ppt5_6_이마트1 {// 굴림체 10
	public static void main(String[] args) {
		...
		String[] k27_itemname = { "초코파이*6개입", "치토스*5개입", "파머스픽 성주 참외", "꿈꾸는콩 촌두부 마을", "철원 오대쌀10kg", "크리넥스 울트라 클린 아쿠아더블롱 30m30롤",
		...
		int[] k27_price = { 3000, 2990000, 12890000, 1950000, 29120, 33700, 4900, 900, 159030, 34110, 15040, 1500, 4500,
				980, 4100, 19900, 10980, 11880, 6784, 70400, 434280, 444808, 125020, 201348, 373744, 252672, 235564,
