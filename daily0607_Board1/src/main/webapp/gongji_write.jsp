  ...
  <table width="850" border="1" cellspacing="0" cellpadding="5">
    <tr>
      <td colspan="3" align="center">
        <h2><b>수정된 게시글 번호는 </b><span style="color: red;">[<%=id%>] 번</span> 입니다.</h2>
      </td>
       <td align="center">
        <input type="button" value="목록보기" onclick="location.href='gongji_list.jsp?id=<%=id%>&pageNumber=<%=pageNumber%>'">
      </td>
       <td align="center">
        <input type="button" value="수정된 게시글 보러가기" onclick="location.href='gongji_view.jsp?id=<%=id%>'">
      </td>
      <td colspan="2" align="center">
        <input type="button" value="재수정" onclick="window.history.back()">
      </td>
    </tr>
  </table>
</form>
